...
describe('ListagemCategoriaComponent', () => {
  ...
  it('should render grid component', () => {
    //Arrange
    const fixture = TestBed.createComponent(ListagemCategoriaComponent);
    const dadosMockados: Categoria[] = [
      { codigoCategoria: 1, descricao: "adolfo"}
    ];
    ...
    expect(celulasDaTabela[0].nativeElement.innerText)
      .toBe(dadosMockados[0].codigoCategoria.toString());
    expect(celulasDaTabela[1].nativeElement.innerText)
      .toBe(dadosMockados[0].descricao);
  });
});
